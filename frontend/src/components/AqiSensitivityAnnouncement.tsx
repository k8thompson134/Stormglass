...
export default function AqiSensitivityAnnouncement({
  onChoose,
  onOptOut,
}: Props) {
  return (
    <div className="mb-6 bg-blue-500/10 border border-blue-500/25 rounded-2xl p-4 sm:p-5">
      <p className="text-blue-300 text-sm font-semibold mb-1">
        New: Air quality safety threshold
      </p>
      <p className="text-[12px] text-gray-300 leading-relaxed mb-4">
        Choose the highest air quality level you consider safe. It sets the
        safe-window callout and chart shading on the Air Quality card. You can
